        ...
        <section class="wpo-page row-offcanvas row-offcanvas-left">
            ...
            <section
                ...
                <header id="wpo-header" class="wpo-header header-v1">
                    ...
                    $promoDateBegin = date('Y-m-d', strtotime("03/17/2017"));
                    $promoDateEnd = date('Y-m-d', strtotime("03/20/2017"));

                    if (($today >= $promoDateBegin) && ($today < $promoDateEnd)) {
                        ?>
                        <div class="promoBar">
                            <span class="noBreak">Enjoy free shipping all weekend!</span> &nbsp; <span class="noBreak">Use code <strong>LUCKYYOU</strong></span> &nbsp; <span class="noBreak">Offer valid through 11:59pm EST 3/19</span>
                        </div>
                        <?PHP
                    }
                    ?>
                                        ...
                                        <?php if (!is_user_logged_in()) { ?>
                                            ...
                                            <li>
                                                <a href="<?php echo esc_url(get_permalink(get_option('woocommerce_myaccount_page_id'))); ?>"
                                                   title="<?php echo __('Register', 'woothemes'); ?>"><?php echo __('Register', 'woothemes'); ?></a>
                                            </li>
                                        <?php } else { ?>
                                            <?php $current_user = wp_get_current_user(); ?>
                                            <li><?php echo __('Welcome ', 'newfashion'); ?><?php echo trim($current_user->display_name); ?>
                                                !
                                            </li>
                                            <li>
                                                <a href="<?php echo wp_logout_url(); ?>"><?php echo __('Log Out', 'newfashion'); ?></a>
                                            </li>
                                        <?php } ?>
                                    </ul>
                                </div>
                                    ...
                                    <ul class="links links-v1 pull-right  nob-l">
                                        ...
                                        <?php if (class_exists('YITH_WCWL')) { ?>
                                            ...
                                            <li class="i-wishlist">
                                                ...
                                                <a href="<?php echo esc_url($wishlist_url) ?>" title="wishlist">
                                                    &nbsp;</a>
                                            </li>
                                        <?php } ?>
                            ...
                            <div class="logo-in-theme a-center">
                                <?php if (newfashion_wpo_theme_options('logo')) { ?>
                                    <a href="<?php echo esc_url(home_url('/')); ?>">
                                        <img src="<?php echo esc_url_raw(newfashion_wpo_theme_options('logo')); ?>"
                                             alt="<?php bloginfo('name'); ?>">
                                    </a>
                                <?php } else { ?>
                                    <a href="<?php echo esc_url(home_url('/')); ?>">
                                        <img src="<?php echo esc_url_raw(get_template_directory_uri() . '/images/logo.png'); ?>"
                                             alt="<?php bloginfo('name'); ?>"/>
                                    </a>
                                <?php } ?>
                            </div>
                    ...
                    <div id="wpo-headBottom" class="wpo-headBottom">
                        <div class="container">
                            <div class="mainmenu a-center">
                                <nav id="wpo-mainnav" data-style='light'
                                     data-duration="<?php echo newfashion_wpo_theme_options('megamenu-duration', 400); ?>"
                                     class="wpo-megamenu <?php echo newfashion_wpo_theme_options('magemenu-animation', 'slide'); ?> animate navbar navbar-mega"
                                     role="navigation">
                                    ...
                                    <svg id="Hamburger" class="header-nav-button " viewBox="0 0 44 44">
                                        <path d="M0,0h44v8.2H0V0z M0,17.9h44v8.2H0V17.9z M0,35.8h44V44H0V35.8z"/>
                                    </svg>

                                    <svg id="Close" class="header-nav-button" viewBox="0 0 44 44">
                                        <polygon points="44,37.1 28.8,21.9 43.8,6.9 37,0 21.9,15 7,0.2 0.2,7 15,21.9 0,37 6.9,43.8 21.9,28.8 37.1,44 "/>
                                    </svg>
