	...
	<div id="st-container" class="st-container">
		<div class="st-pusher">
			...
			<section class="wpo-wrapper <?php echo isset($meta_template['el_class']) ? esc_attr( $meta_template['el_class'] ) : '' ; ?>">
				...
				<!-- HEADER -->
				<header id="wpo-header" class="wpo-header header-v2">     
					...
					<div id="wpo-topbar" class="wpo-topbar">	
						<div class="container">
							<div class="row">
								...
								<div class="col-lg-5 col-md-6 col-sm-6 col-xs-12 hidden-sm hidden-xs">
									<?php if(is_dynamic_sidebar('info-topbar')): ?>
										<?php dynamic_sidebar( 'info-topbar' ); ?>
									<?php endif; ?>									
								</div>
								
								<div class="col-lg-5 col-md-6 col-sm-6 col-xs-12 hidden-md hidden-lg">	
					...
					<div id="wpo-headMain" class="wpo-headMain space-padding-tb-30 ">
						<div class="container">
							<div class="row d-table">
								<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 d-table-cell">
								...
								<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 d-table-cell no-padding hidden-sm hidden-xs">
								...
								<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 d-table-cell hidden-sm hidden-xs">	
