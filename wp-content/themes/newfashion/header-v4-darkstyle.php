	...
	<div id="st-container" class="st-container">
		<div class="st-pusher">
			...
			<section class="wpo-wrapper <?php echo isset($meta_template['el_class']) ? esc_attr( $meta_template['el_class'] ) : '' ; ?>">
				...
				<!-- HEADER -->
				<header id="wpo-header" class="wpo-header header-v4">     
						...
						<div class="container">
							<div class="row">
								<div class="col-lg-7 col-md-6 col-sm-6 col-xs-6">
									...
									<?php if(is_active_sidebar('social-header')) dynamic_sidebar('social-header'); ?>
								</div>
					...
					<div id="wpo-headMain" class="wpo-headMain v-dark">
						<div class="container">
					...
					<div id="wpo-headBottom" class="wpo-headBottom hidden-sm hidden-xs">
						<div class="container">				
