		...
		param_start_ajax_embed : function (oembed_url,parent_id){
		    jQuery.ajax({
				...
				success: function (response) {
					...
					if(response.check){
	                    jQuery(parent_id+' .newfashion_wpo_embed_view .result').addClass('active').append(response.video);
	                    jQuery(parent_id+' .newfashion_wpo_embed_view .result').append('<a class="remove-embed"></a>');
	                	...
	                	jQuery(parent_id+' .newfashion_wpo_embed_view .result').append(response.video);
	                }
				}
			});
		},
