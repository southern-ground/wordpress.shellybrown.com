...
class Newfashion_Facebook_Like_Box extends Newfashion_Widget {
    public function __construct() {
        parent::__construct(
            // Base ID of your widget
            'newfashion_facebook_like',
            // Widget name will appear in UI
            __('WPO Facebook Like Box', 'newfashion'),
            // Widget description
            array( 'description' => __( 'Adds support for Facebook Like Box. ', 'newfashion' ), )
        );
...
register_widget( 'Newfashion_Facebook_Like_Box' );