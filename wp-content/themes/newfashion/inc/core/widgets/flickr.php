...
class Newfashion_Flickr_Widget extends Newfashion_Widget {
    public function __construct() {
        parent::__construct(
            // Base ID of your widget
            'newfashion_flickr_widget',
            // Widget name will appear in UI
            __('WPO Flickr', 'newfashion'),
            // Widget description
            array( 'description' => __( 'The most recent photos from flickr.', 'newfashion' ), )
        );
...
register_widget( 'Newfashion_Flickr_Widget' );