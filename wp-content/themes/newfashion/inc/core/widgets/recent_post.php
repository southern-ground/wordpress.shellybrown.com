...
class Newfashion_Recent_Post extends Newfashion_Widget {
    public function __construct() {
        parent::__construct(
            // Base ID of your widget
            'newfashion_recent_post',
            // Widget name will appear in UI
            __('WPO Recent Posts Widget', 'newfashion'),
            // Widget description
            array( 'description' => __( 'Show list of recent post', 'newfashion' ), )
        );
...
// Widget Backend
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'number_post' )); ?>"><?php _e( 'Num Posts:', 'newfashion' ); ?></label>
...
register_widget( 'Newfashion_Recent_Post' );