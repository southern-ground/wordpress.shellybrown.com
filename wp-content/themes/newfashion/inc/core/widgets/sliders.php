...
class Newfashion_Sliders_Widget extends Newfashion_Widget{
    ...
    public function __construct() {
        parent::__construct(
            ...
            __('WPO Sliders Widget', 'newfashion'),
            // Widget description
            array( 'description' => __( 'Adds support Slider. ', 'newfashion' ), )
        );
    ...
    public function initScripts(){
        $url = WPO_FRAMEWORK_PATH.'/widgets/sliders/assets/';
        wp_enqueue_script('newfahion-camera_js',$url.'js/camera.min.js');
        wp_enqueue_script('newfahion-kwicks_js',$url.'js/jquery.kwicks.min.js');

        wp_enqueue_style( 'newfahion-camera_css', $url.'css/camera.css');
        wp_enqueue_style( 'newfahion-kwicks_css', $url.'css/accordion.kwicks.min.css');
    }
}

register_widget( 'Newfashion_Sliders_Widget' );
