...
class Newfashion_Socials_Widget extends Newfashion_Widget {
    public function __construct() {
        parent::__construct(
            // Base ID of your widget
            'newfashion_socials_widget',
            // Widget name will appear in UI
            __('WPO Socials', 'newfashion'),
            // Widget description
            array( 'description' => __( 'Socials for website.', 'newfashion' ), )
        );
...
register_widget( 'Newfashion_Socials_Widget' );