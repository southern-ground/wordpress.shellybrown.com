...
class Newfashion_Socials_Siderbar_Widget extends Newfashion_Widget {
    public function __construct() {
        parent::__construct(
            // Base ID of your widget
            'newfashion_socials_siderbar_widget',
            // Widget name will appear in UI
            __('WPO Socials Siderbar', 'newfashion'),
            // Widget description
            array( 'description' => __( 'Share Socials Siderbar for website.', 'newfashion' ), )
        );
...
// Widget Backend
    ...
    ?>
    <div class="newfashion_socials_siderbar">
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'list_service' )); ?>"><?php echo __( 'Share services social:', 'newfashion' ); ?></label>
            <br>
...
register_widget( 'Newfashion_Socials_Siderbar_Widget' );