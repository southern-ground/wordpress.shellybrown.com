...
class Newfashion_Tabs_Widget extends Newfashion_Widget {
    public function __construct() {
        parent::__construct(
            // Base ID of your widget
            'newfashion_tabs_widget',
            // Widget name will appear in UI
            __('WPO Tabs Widget', 'newfashion'),
            // Widget description
            array( 'description' => __( 'Popular posts, recent post and comments.', 'newfashion' ), )
        );
...
register_widget( 'Newfashion_Tabs_Widget' );