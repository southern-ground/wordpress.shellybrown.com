		...
		<div class="entry-thumb">
			<?php
				...
				<?php
					...
					$_imgs = newfashion_newfashion_wpo_gallery();
				?>
				...
				<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>">
					<?php the_post_thumbnail( 'newfashion-fullwidth' );?>
				</a>
				<?php }
			?>
		</div>
		...
		<div class="entry-content">
			<div class="row">
				<div class="col-lg-4 col-md-4">
					<h4 class="entry-name">
						<?php _e('project description','newfashion'); ?>
					</h4>
				...
				<div class="col-lg-4 col-md-4">
					<h4 class="entry-name">
						<?php _e('quick info','newfashion'); ?>
					</h4>
					<ul class="list-unstyled">
						<li>
							<span class="text-primary"><?php _e('Author:','newfashion'); ?></span>
							<?php the_author(); ?>
						</li>
						<li>
							<span class="text-primary"><?php _e('Category:','newfashion'); ?></span>
							<?php the_terms( $post->ID, 'portfolio_categories' ); ?>
						</li>
						<li>
							<span class="text-primary"><?php _e('Date:','newfashion'); ?></span>
