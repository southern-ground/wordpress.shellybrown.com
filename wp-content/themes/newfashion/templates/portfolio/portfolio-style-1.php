 ...
 */
wp_enqueue_script( 'newfashion-isotope_js', NEWFASHION_WPO_THEME_URI.'/js/isotope.pkgd.min.js', array( 'jquery' ) );
wp_enqueue_script( 'newfashion-prettyPhoto_js', NEWFASHION_WPO_THEME_URI.'/js/jquery.prettyPhoto.js', array( 'jquery' ) );
wp_enqueue_style( 'newfashion-prettyPhoto_css', NEWFASHION_WPO_THEME_URI.'/css/prettyPhoto.css');
        ...
        <div class="ih-item square effect2">
          <a href="<?php the_permalink(); ?>">
            ...
            <div class="info">
              <h3><?php the_title(); ?></h3>
              <p>
                <?php echo newfashion_excerpt(20,'...'); ?>
              </p>
            </div>
          </a>
        </div>              
