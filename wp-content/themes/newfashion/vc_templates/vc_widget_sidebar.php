...
//
$css_class = apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, 'widget wpb_widgetised_column wpb_content_element' . $el_class, $this->settings['base'], $atts );
$output .= "\n\t".'<div class="'.$css_class.'">';
$output .= "\n\t\t".'<div class="wpb_wrapper">';
$output .= wpb_widget_title(array('title' => $title, 'extraclass' => 'widget_title wpb_widgetised_column_heading'));
$output .= "\n\t\t\t".$sidebar_value;
