...
extract( $atts );
    ...
    $deals = array();
    $p_deals = newfashion_woocommerce_query('deals')->posts;
    ...
    wp_register_script( 'countdown_js', NEWFASHION_WPO_THEME_URI.'/js/countdown.js', array( 'jquery' ) );
            ...
            <div class="widget-content widget_products slide" id="productcarouse-<?php echo esc_attr($_id); ?>" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <?php if( $_count%$columns_count == 1 || $columns_count ==1 ) echo '<div class="item'.(($_count==1)?" active":"").'"><div class="row">'; ?>
                            ...
                            <div class="item-product <?php echo esc_html($class_column); if($_count%$columns_count==0) echo ' last'; ?>">
