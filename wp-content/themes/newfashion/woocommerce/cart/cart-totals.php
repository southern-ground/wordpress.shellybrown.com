...
?>
<div class="cart_totals heading-v2 <?php if ( WC()->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?>">

	<?php do_action( 'woocommerce_before_cart_totals' ); ?>

	<h3 class="widget-title"><span><?php _e( 'Cart Totals', 'woocommerce' ); ?></span></h3>
