                ...
                <div class="product-meta">
                    ...
                    <?php if(newfashion_wpo_theme_options('is-quickview',true)){ ?>
                        <div class="quick-view">
                            <a href="#" class="quickview hidden-xs hidden-sm" data-productslug="<?php echo esc_attr($product->post->post_name); ?>" data-toggle="modal" data-target="#wpo_modal_quickview"> <span><?php echo __('Quick view','newfashion'); ?></span> </a>
                        </div>
                    <?php } ?>
                ...
                <div class="product-assets">
        			...
        			<div class="button-groups">
                        ...
                        <div class="yith-compare hidden-xs hidden-sm">
                            <a href="<?php echo wp_nonce_url( add_query_arg( $url_args ), $action_add ); ?>" class="compare" data-product_id="<?php echo esc_html($product->id); ?>"> <i class="fa fa-files-o"></i> <span><?php echo __('add to compare','newfashion'); ?></span> </a>
                        </div>
                        <?php } ?>
        	        </div>
                </div>
