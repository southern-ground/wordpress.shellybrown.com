...
class Newfashion_Widget_Product_Categories extends WC_Widget_Product_Categories {
	...
	public function widget( $args, $instance ) {
		...
		// List
			...
			require_once(  NEWFASHION_WPO_THEME_DIR.('/woocommerce/walkers/product-cat-list.php') );

			$cat_args['walker']                     = new Newfashion_Product_Cat_List_Walker;
			$cat_args['title_li']                   = '';
...
register_widget( 'Newfashion_Widget_Product_Categories' );